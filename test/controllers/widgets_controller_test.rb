...
class WidgetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create widget" do
    assert_difference('Widget.count') do
      post widgets_url, params: { widget: { description: @widget.description, kind: @widget.kind, name: @widget.name } }
    end
  ...
  test "should update widget" do
    patch widget_url(@widget), params: { widget: { description: @widget.description, kind: @widget.kind, name: @widget.name } }
